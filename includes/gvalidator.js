...
///////////////////////////////////////////////////////////////////////////////////
// Required functions: Remove any functions that exist in your library
///////////////////////////////////////////////////////////////////////////////////
...
ONEGEEK.forms.AbstractFormField = function(field) {
  ...
  this.successMessage = 'Thank You!'; // Messages displayed to user on successful completion
  this.errorMessage = 'Please complete';   // Messages displayed to user on completion error
  this.contextMessage = 'Please select your campaign type.';  // Messages displayed to user when they are filling out field
  ...
  this.setState = function(state) { 
    ...
    switch(state) {
      ...
      case FIELD_STATUS_OK:
        ...
        break;
      case FIELD_STATUS_NONE:
        message = null;
        util.addClass(this.messageSpan, 'hidden');
        util.addClass(this.fieldStatus, 'hidden');
      default:
       src = ICON_INFO;
...
ONEGEEK.forms.NameField = function(field) {
  ...
  this.isRequired = true;  
  this.errorMessage   = 'Enter between 2 and 30 characters';
  this.contextMessage = 'Enter between 2 and 30 characters'; 
...
ONEGEEK.forms.CaptchaTextField = function(field) {
  ...
  this.contextMessage = "Enter a number, the cost of your campaign.";
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//My Attempt at Custom Field Definition, for name of campaign:
ONEGEEK.forms.CampaignnameTextField = function(field) {
this.field = field;
this.name = 'campaignname';
this.isRequired = true;
this.regex = /[a-zA-Z0-9-\'\s]/g
//this.regex = /([a-zA-Z0-9-\'\s]{2,30})/g
this.cleanRegex = /[^0-9a-zA-Z-\'\s]/g
this.isRequired = true; 
this.errorMessage = 'Enter between 2 and 30 characters';
this.contextMessage = 'This will be your name for your new campaign';

this.getNewInstance = function(field) {
return new ONEGEEK.forms.CampaignnameTextField(field);
}
...
if(validated) {
	...
	//this.setState(FIELD_STATE_OK);
	checkCampaignName(this.field.value, this);
	} else {
		if(this.modified == false) {
			//this.setState(FIELD_STATUS_INFO);
		} else {
...
ONEGEEK.forms.CampaignnameTextField.prototype = new ONEGEEK.forms.AbstractTextField; 

// Register the field types with FormFieldFactory
formFieldFactory.registerFormField('campaignname', new ONEGEEK.forms.CampaignnameTextField());



//End of my custom field definition
...
ONEGEEK.forms.Form = function(form) {
  ...
  var form = form || document.getElementById(form) || null;  // DOM form object
  var completed = false;
