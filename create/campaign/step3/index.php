...
?>
		<?php # Help Button
		$helphref = 'create-campaign-step-3.html';
...
';
	if(isset($_SESSION['campaign_domain'])) {
		switch($_SESSION['campaign_domain']) {
			case 'actionpagelink':
...
?>
	...
	<form action="" method="post" name="campform" id="create_campaign_step3" class="steps-form">
		<fieldset>
			<div class="row add">
	...
	<div class="content-link">
		<div class="link-holder">
			<div class="link-frame">
				...
				<a href="#" class="btn" onclick="document.getElementById('create_campaign_step3').submit();" /><span>Finalize Campaign &gt;</span></a>
				<em>or</em>
