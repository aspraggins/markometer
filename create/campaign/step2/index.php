...
if($_SESSION['leadimport']=='N') { //is this a file importation?
	if($_SESSION['campaign_type']!=6) { //(NOT PPC)
		...
		$helphref = 'create-campaign-step-2-domain-name.html';
		...
		$actionpageie = '';
		$helphref = 'create-campaign-step-2-ppc';
...
echo '
<form action="#" method="post" id="create_campaign_step2" name="campform" class="steps-form">
<fieldset>
...
<div class="content-link">
	<div class="link-holder">
		<div class="link-frame">
			<a class="btn btn-left" href="/create/campaign/step1/"><span>&lt; Previous Step</span></a>
			<a href="#" class="btn" onclick="document.getElementById(\'create_campaign_step2\').submit();" /><span>Save &amp; Go To Next Step &gt;</span></a>
			<em>or</em>
...
';
	...
	$file_open = 0;
echo'
<form enctype="multipart/form-data" action="import.php" method="post" id="create_campaign_step2_upload" class="steps-form">
<fieldset>
