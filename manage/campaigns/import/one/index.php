...
$metatitle = 'Import a Lead Into Your Campaign';
...
<div class="heading">
<h1>Import a Lead Into Your Campaign</h1>
<a href="help.html" class="btn-help" title="Help" onclick="Modalbox.show(this.href, {title: this.title, width: 600, evalScript: true}); return false;"><span>Help?</span></a>
</div>
...
<div class="alert-holder">
	...
	if($fn && $ln) {
		...
		"email, address, city, state, zip, country,status,date_created,last_updated) " . 
		"VALUES ('{$_SESSION['account_id']}','$campaign_id', '$fn', '$ln', '$t', '$c', '$p', '$e',  '$a'," .
		"'$city', '$state', '$zip', '$country', 'N', NOW(), NOW())";
		...
		if (mysqli_affected_rows ($dbc) == 1) {
			...
			$url = '/manage/campaigns/edit?indid=' . $campaign_id . '&saved=one';
			header("Location: $url");
			exit();
		}else{
		echo '
...
<div class="row">
	...
	<input type="text" class="text middle" name="first" maxlength="80" value="<?php if (isset($_POST['first'])) echo $_POST['first']; ?>" />
	<label>Last Name:</label>
	<input type="text" class="text edit" name="last" maxlength="80" value="<?php if (isset($_POST['last'])) echo $_POST['last']; ?>" />
</div>
<div class="row">
	<label class="title">Title:</label>
	<input type="text" class="text" name="title" maxlength="80" value="<?php if (isset($_POST['title'])) echo $_POST['title']; ?>" />
</div>
<div class="row">
	<label class="title">Company:</label>
	<input type="text" class="text" name="company" maxlength="80" value="<?php if (isset($_POST['company'])) echo $_POST['company']; ?>" />
</div>
<div class="row">
	<label class="title">Phone:</label>
	<input type="text" class="text" name="phone" maxlength="80" value="<?php if (isset($_POST['phone'])) echo $_POST['phone']; ?>" />
</div>
<div class="row">
...
<div class="row">
	...
	<textarea rows="10" cols="30" id="area" name="address"><?php if (isset($_POST['address'])) echo $_POST['address']; ?></textarea>
</div>
<div class="row">
	<label class="title">City:</label>
	<input type="text" class="text" name="city" maxlength="80" value="<?php if (isset($_POST['city'])) echo $_POST['city']; ?>" />
</div>
<div class="row">
	<label class="title">State:</label>
	<input type="text" class="text" name="state" maxlength="80" value="<?php if (isset($_POST['state'])) echo $_POST['state']; ?>" />
</div>
<div class="row">
	<label class="title">Zip/Postal Code:</label>
	<input type="text" class="text" name="zip" maxlength="80" value="<?php if (isset($_POST['zip'])) echo $_POST['zip']; ?>" />
</div>
<div class="row">
	<label class="title">Country:</label>
	<input type="text" class="text" name="country" maxlength="80" value="<?php if (isset($_POST['country'])) echo $_POST['country']; ?>" />
</div>
