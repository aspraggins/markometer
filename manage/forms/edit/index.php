<? #copy index.php, tweaked to allow editing of existing form when called from Manage==>Forms
//Programmer: Ray Neel 1/2009, revising for use 5/2009
...
//pull in name of form from variable:
if(isset($_GET['name'])) {
	$name = $_GET['name'];
}
?> 
...
echo 'Manage a Form&nbsp;<a href="/manage/help.php" title="Help" onclick="Modalbox.show(this.href, 
{title: this.title, width: 600, evalScript: true}); return false;">Help</a></h1><br /><br />';

echo '<table border="1"><th>' . $name . '</th></table><br /><br />';

echo '<form name="formform" action="/manage/forms/edit/saveedit.php" method="post">';
echo '<b>Form Title:</b><input type="text" name="formname" id="formname" size="40" maxlength="40"
value="';
if(isset($name)) echo $name;
echo '" onchange="checkFormName()" /><br />
...
/*echo '<input type="button" name="submitbutton" value="Save Form and Exit" 
...
Save Form</a>&nbsp;or&nbsp;<a href="/manage/" style="color:#09c;font-size:16px;text-decoration:none;font-weight:600;	font-family:verdana, arial, helvetica, sans-serif;">Cancel</a>
