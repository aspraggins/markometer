...
$q = "SELECT * FROM accounts WHERE mp_subdomain='$cname'";
...
if($num==0 && $validated) {
	echo '<font color="green">That site address is available!</font>';
} elseif(!$validated) {
	echo "Please enter between 2 and 20 characters.";	
} else {
	echo "<font color='red'>The site address <b>$cname</b> is taken, please try another.</font>";	
}
