	...
	if(isset($_POST['chooseaction'])) {
		if(strlen(trim($_POST['chooseaction']))>0) {
			...
			if (mysqli_affected_rows($dbc) == 1) {
				$url = '/build/campaigns/?action=pagechosen';
				header("Location: $url");
			} else {
...
echo $_SESSION['campaign_domain'] ;
		...
		echo '
<strong>Display URL (to show in ad): </strong>'; 
echo '
<div class="list-holder">
	<div class="list-frame">
		<div class="list-wrap">
			<span>';
echo $_SESSION['mp_subdomain'] . '.mp41.com<br /><br />';

		echo '<strong>Destination URL(to link to from ad): </strong>' . $_SESSION['mp_subdomain'] . '.mp41.com/' . $_SESSION['campaign_name_dashes'];
	}
...
<?php
// Show Action Page Stuff if there is a domain associated with this campaign:
if ($_SESSION['campaign_domain']!='nodomain') {
	echo '<div class="column"><div class = "column-box">';
	echo '
	...
	<div class="content-link">
		<div class="link-holder">
			<div class="link-frame">
				<a class="btn" href="/build/actionpages/new/choose/?camp=';
