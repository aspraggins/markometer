...
$metatitle = 'Create and Edit Your Forms';
$returnurl = '/login/?returnpage=build/forms';
...
<div class="content-link top-link">
	<div class="link-holder">
		<div class="link-frame">
			<a class="btn" href="/build/forms/choose/"><span>Create a New Form &gt;</span></a>
		</div>
	</div>
</div>
...
$q = "SELECT id, name, date_modified, date_created " .   
"FROM forms " . 
...
';
	...
	while ($row = mysqli_fetch_array($r,MYSQLI_ASSOC)) {
		...
		//changing query so doesn't require action page to be in a 
		//campaign, AND use this form. Not sure why did it this more stringent way...?
		$q = "SELECT form_id FROM action_pages WHERE form_id='$formid'";
		...
		<td> 
		<a href="/build/forms/edit/?action=existing&formID=' . $row['id'] . '&name=' . $row['name'] . '">' . $row['name'] . '</a> 
		</td>
